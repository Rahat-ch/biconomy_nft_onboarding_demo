...
export default function App() {
  ...
  return (
    <div className={styles.demoContainter}>
      ...
      {
        !smartAccount && !loading && <button className={styles.demoButton} onClick={login}>Login</button>
      }
      {
        loading && (
          <div>
      ...
      }
      {
        !!smartAccount && (
          <div className={styles.buttonWrapper}>
            ...
            <button className={styles.demoButton} onClick={logout}>Logout</button>
          </div>
        )
      }
      <br />
